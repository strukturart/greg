...
exports.validate = exports.uid = exports.top_bar = exports.sort_array = exports.side_toaster = exports.screenlock = exports.pushLocalNotification = exports.pick_image = exports.notification = exports.list_files = exports.goodbye = exports.getManifest = exports.deleteFile = exports.bottom_bar = void 0;
...
},{"/assets/js/helper.js":"assets/js/helper.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
var callback_scan = function callback_scan(url) {
  (0, _helper.bottom_bar)("QR", "save", "cancel");
...
var store_event = function store_event() {
  ...
  _localforage.default.setItem("events", without_subscription).then(function (value) {
    (0, _helper.toaster)("saved", 2000); // clean form
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "39629" + '/');
