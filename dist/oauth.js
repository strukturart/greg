    ...
    return (function e1(t, n, r) {
        ...
        1: [
            function(_dereq_, module, exports) {
                (function(global) {
                    "use strict";
                    var nextTick = //named nextTick for less confusing stack traces
                    function nextTick() {
                        draining = true;
                        var i, oldQueue;
                    ...
                    var immediate = function immediate(task) {
                    ...
                    } else if ("document" in global && "onreadystatechange" in global.document.createElement("script")) scheduleDrain = function scheduleDrain() {
        ...
        2: [
            function(_dereq_, module, exports) {
                "use strict";
                var INTERNAL = /* istanbul ignore next */ function INTERNAL() {};
                ...
                var QueueItem = function QueueItem(promise, onFulfilled, onRejected) {
                ...
                var unwrap = function unwrap(promise, func, value) {
                    immediate(function() {
                        var returnValue;
                        try {
                ...
                var getThen = function getThen(obj) {
                ...
                var safelyResolveThenable = function safelyResolveThenable(self, thenable) {
                ...
                var tryCatch = function tryCatch(func, value) {
                    var out = {};
                    try {
                ...
                var race = function race(iterable) {
                    var self = this;
                    if (Object.prototype.toString.call(iterable) !== "[object Array]") return this.reject(new TypeError("must be an array"));
                    var len = iterable.length;
                    var called = false;
        ...
        4: [
            function(_dereq_, module, exports) {
                ...
                var isIndexedDBValid = function isIndexedDBValid() {
                    try {
                ...
                var createBlob = // Abstracts constructing a Blob object, so it also works in older
                ...
                var executeTwoCallbacks = function executeTwoCallbacks(promise, callback, errorCallback) {
                ...
                var _binStringToArrayBuffer = // Transform a binary string to an array buffer, because otherwise
                ...
                var _checkBlobSupportWithoutCaching = //
                ...
                var _checkBlobSupport = function _checkBlobSupport(idb) {
                ...
                var _deferReadiness = function _deferReadiness(dbInfo) {
                ...
                var _advanceReadiness = function _advanceReadiness(dbInfo) {
                    var dbContext = dbContexts[dbInfo.name];
                ...
                var _rejectReadiness = function _rejectReadiness(dbInfo, err) {
                    var dbContext = dbContexts[dbInfo.name];
                    // Dequeue a deferred operation.
                    var deferredOperation = dbContext.deferredOperations.pop();
                ...
                var _getConnection = function _getConnection(dbInfo, upgradeNeeded) {
                ...
                var _getOriginalConnection = function _getOriginalConnection(dbInfo) {
                    return _getConnection(dbInfo, false);
                };
                var _getUpgradedConnection = function _getUpgradedConnection(dbInfo) {
                    return _getConnection(dbInfo, true);
                };
                var _isUpgradeNeeded = function _isUpgradeNeeded(dbInfo, defaultVersion) {
                ...
                var _encodeBlob = // encode a blob for indexeddb engines that don't support blobs
                ...
                var _decodeBlob = // decode an encoded blob
                ...
                var _isEncodedBlob = // is this one of our fancy encoded blobs?
                function _isEncodedBlob(value) {
                    return value && value.__local_forage_encoded_blob;
                };
                var _fullyReady = // Specialize the default `ready()` function by making it dependent
                ...
                var _tryReconnect = // Try to establish a new db connection to replace the
                ...
                var createDbContext = function createDbContext() {
                    return {
                ...
                var _initStorage = // Open the IndexedDB database (automatically creates one if one didn't
                ...
                var getItem = function getItem(key, callback) {
                    var self = this;
                ...
                var iterate = // Iterate over all items stored in database.
                ...
                var setItem = function setItem(key, value1, callback) {
                    var self = this;
                    key = normalizeKey(key);
                    var promise = new Promise$1(function(resolve, reject) {
                        var dbInfo;
                ...
                var removeItem = function removeItem(key, callback) {
                    var self = this;
                    key = normalizeKey(key);
                    var promise = new Promise$1(function(resolve, reject) {
                        self.ready().then(function() {
                ...
                var length1 = function length1(callback) {
                    var self = this;
                    var promise = new Promise$1(function(resolve, reject) {
                        self.ready().then(function() {
                            createTransaction(self._dbInfo, READ_ONLY, function(err, transaction) {
                ...
                var key1 = function key1(n, callback) {
                    var self = this;
                    var promise = new Promise$1(function(resolve, reject) {
                        if (n < 0) {
                            resolve(null);
                ...
                var keys1 = function keys1(callback) {
                    var self = this;
                    var promise = new Promise$1(function(resolve, reject) {
                        self.ready().then(function() {
                            createTransaction(self._dbInfo, READ_ONLY, function(err, transaction) {
                ...
                var dropInstance = function dropInstance(options, callback) {
                ...
                var isWebSQLValid = function isWebSQLValid() {
                    return typeof openDatabase === "function";
                };
                var stringToBuffer = function stringToBuffer(serializedString) {
                ...
                var bufferToString = // Converts a buffer to a string to store, serialized, in the backend
                // storage library.
                ...
                var serialize = // Serialize a value, afterwards executing a callback (which usually
                ...
                var deserialize = // Deserialize data we've inserted into a value column/field. We place
 ...
 */ function createDbTable(t, dbInfo, callback, errorCallback) {
                ...
                var _initStorage$1 = // Open the WebSQL database (automatically creates one if one didn't
                // previously exist), using any options set in the config.
                ...
                var tryExecuteSql = function tryExecuteSql(t1, dbInfo, sqlStatement, args, callback, errorCallback) {
                ...
                var getItem$1 = function getItem$1(key, callback) {
                    var self = this;
                    key = normalizeKey(key);
                    var promise = new Promise$1(function(resolve, reject) {
                        self.ready().then(function() {
                ...
                var iterate$1 = function iterate$1(iterator, callback) {
                    var self = this;
                    var promise = new Promise$1(function(resolve, reject) {
                        self.ready().then(function() {
                            var dbInfo = self._dbInfo;
                ...
                var setItem$1 = function setItem$1(key, value, callback) {
                ...
                var removeItem$1 = function removeItem$1(key, callback) {
                    var self = this;
                    key = normalizeKey(key);
                    var promise = new Promise$1(function(resolve, reject) {
                        self.ready().then(function() {
                ...
                var clear$1 = // Deletes every item in the table.
                ...
                var length$1 = // Does a simple `COUNT(key)` to get the number of items stored in
                // localForage.
                ...
                var key$1 = // Return the key located at key index X; essentially gets the key from a
                ...
                var keys$1 = function keys$1(callback) {
                    var self = this;
                    var promise = new Promise$1(function(resolve, reject) {
                        self.ready().then(function() {
                            var dbInfo = self._dbInfo;
                ...
                var getAllStoreNames = // https://www.w3.org/TR/webdatabase/#databases
                ...
                var dropInstance$1 = function dropInstance$1(options, callback) {
                    callback = getCallback.apply(this, arguments);
                    var currentConfig = this.config();
                    options = typeof options !== "function" && options || {};
                    if (!options.name) {
                ...
                var isLocalStorageValid = function isLocalStorageValid() {
                    try {
                ...
                var _getKeyPrefix = function _getKeyPrefix(options, defaultConfig) {
                    var keyPrefix = options.name + "/";
                    if (options.storeName !== defaultConfig.storeName) keyPrefix += options.storeName + "/";
                    return keyPrefix;
                };
                var checkIfLocalStorageThrows = // Check if localStorage throws when saving an item
                ...
                var _isLocalStorageUsable = // Check if localStorage is usable and allows to save an item
                ...
                var _initStorage$2 = // Config the localStorage backend, using options set in the config.
                ...
                var clear$2 = // Remove all keys from the datastore, effectively destroying all data in
                ...
                var getItem$2 = // Retrieve an item from the store. Unlike the original async_storage
                ...
                var iterate$2 = // Iterate over all items in the store.
                ...
                var key$2 = // Same as localStorage's key() method, except takes a callback.
                ...
                var keys$2 = function keys$2(callback) {
                    var self = this;
                    var promise = self.ready().then(function() {
                        var dbInfo = self._dbInfo;
                        var length = localStorage.length;
                ...
                var length$2 = // Supply the number of keys in the datastore to the callback function.
                ...
                var removeItem$2 = // Remove an item from the store, nice and simple.
                ...
                var setItem$2 = // Set a key's value and run an optional callback once the value is set.
                // Unlike Gaia's implementation, the callback function is passed the value,
                // in case you want to operate on that value only after you're sure it
                // saved, or something like that.
                function setItem$2(key, value2, callback) {
                    var self = this;
                    key = normalizeKey(key);
                    var promise = self.ready().then(function() {
                        ...
                        return new Promise$1(function(resolve, reject) {
                            var dbInfo = self._dbInfo;
                            dbInfo.serializer.serialize(value2, function(value, error) {
                ...
                var dropInstance$2 = function dropInstance$2(options, callback) {
                    callback = getCallback.apply(this, arguments);
                    options = typeof options !== "function" && options || {};
                    if (!options.name) {
                        var currentConfig = this.config();
                ...
                var callWhenReady = function callWhenReady(localForageInstance, libraryMethod) {
                ...
                var _typeof = typeof Symbol === "function" && (0, $ffd930d6675a10cb$export$2e2bcd8739ae039)(Symbol.iterator) === "symbol" ? function _typeof(obj) {
                    return typeof obj === "undefined" ? "undefined" : (0, $ffd930d6675a10cb$export$2e2bcd8739ae039)(obj);
                } : function(obj) {
                    return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj === "undefined" ? "undefined" : (0, $ffd930d6675a10cb$export$2e2bcd8739ae039)(obj);
                };
                var idb1 = getIDB();
                ...
                function _setItem(key, value3, callback, retriesLeft) {
                    var self = this;
                    key = normalizeKey(key);
                    var promise = new Promise$1(function(resolve, reject) {
                        self.ready().then(function() {
                            ...
                            var dbInfo = self._dbInfo;
                            dbInfo.serializer.serialize(value3, function(value, error1) {
                ...
                var LocalForage1 = function() {
                    ...
                    LocalForage.prototype.setDriver = function setDriver(drivers, callback, errorCallback) {
                        var setDriverToConfig = function setDriverToConfig() {
                            self._config.driver = self.driver();
                        };
                        var extendSelfWithDriver = function extendSelfWithDriver(driver) {
                            self._extend(driver);
                            setDriverToConfig();
                            self._ready = self._initStorage(self._config);
                            return self._ready;
                        };
                        var initDriver = function initDriver(supportedDrivers) {
                            return function() {
...
function $b17776f098274076$export$e2a22331486dcca0(len) {
    var i = 0, tmp = len || 11;
    if (!$b17776f098274076$var$BUFFER || $b17776f098274076$var$IDX + tmp > $b17776f098274076$var$SIZE * 2) for($b17776f098274076$var$BUFFER = "", $b17776f098274076$var$IDX = 0; i < $b17776f098274076$var$SIZE; i++)$b17776f098274076$var$BUFFER += $b17776f098274076$var$HEX[Math.random() * 256 | 0];
    return $b17776f098274076$var$BUFFER.substring($b17776f098274076$var$IDX, ($b17776f098274076$var$IDX++) + tmp);
}
...
var $5a690edfed81b18a$var$get_token = function get_token() {
    ...
    console.log(code);
    var r = code.split("&code=");
    var b = r[1].split("&");
    localStorage.setItem("authorizationCode", b[0]);
    $5a690edfed81b18a$var$authorizationCode = b[0];
    ...
    return fetch("https://oauth2.googleapis.com/token", requestOptions).then(function(response) {
        return response.json();
    });
};
$5a690edfed81b18a$var$get_token().then(function(result) {
    ...
    (0, (/*@__PURE__*/$parcel$interopDefault($9fbe31c6ff058869$exports))).getItem("accounts").then(function(value) {
        if (value == null) accounts = []; //return false;
        else accounts = value;
        accounts.push({
            server_url: "https://apidata.googleusercontent.com/caldav/v2/",
            tokens: result,
            authorizationCode: $5a690edfed81b18a$var$authorizationCode,
            name: "Google",
            id: (0, $b17776f098274076$export$e2a22331486dcca0)(32),
            type: "oauth"
        });
        (0, (/*@__PURE__*/$parcel$interopDefault($9fbe31c6ff058869$exports))).setItem("accounts", accounts).then(function() {
            document.getElementById("success").innerText = "Account successfully added to greg";
