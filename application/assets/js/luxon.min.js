var luxon = (function (e) {
  ...
  function vt(e, t) {
    return [
      { year: yt(e, t), month: yt(e, t + 1, 1), day: yt(e, t + 2, 1) },
      null,
      t + 3,
    ];
  }
  ...
  function En(e) {
    ...
    return (
      o < 1
        ...
        ? ((t = n + 1), (o = 1))
        : (t = n),
      s({ weekYear: t, weekNumber: o, weekday: i }, he(e))
    );
  }
  function In(e) {
    var t,
  ...
  var tr = (function () {
    ...
    (w.now = function () {
      ...
      (w.fromJSDate = function (e, t) {
        ...
        return e.isValid
          ? new w({ ts: n, zone: e, loc: st.fromObject(t) })
          : w.invalid(Ln(e));
      }),
      ...
      (w.fromISO = function (e, t) {
        void 0 === t && (t = {});
        var n = ft(e, [Ct, At], [Ft, zt], [Zt, jt], [Lt, qt]);
