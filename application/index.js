...
let event_check_day = function (date) {
  ...
  console.log(document.querySelectorAll("div#event-slider article").length);

  if (document.querySelectorAll("div#event-slider article").length == 0)
    return false;
...
let set_tabindex = function () {
  if (document.querySelectorAll("div#list-view article").length == 0)
    return false;
...
function renderHello(arr) {
  ...
  // format date
  if (document.querySelectorAll("article").length == 0) return false;
...
document.addEventListener("DOMContentLoaded", function (e) {
  ...
  if (document.querySelectorAll('input[type="time"]').length) {
  ...
  if (document.querySelectorAll('input[type="date"]').length) {
